...
const ChampionCard = props => {
    ...
    const onClick = () => {
        ...
        // Replace 'item.video' with the GTA VI trailer video ID
        const videoUrl = `https://www.youtube.com/embed/HLgLPRWyLsY?si=-Staf6IdK_2v0nCh` // Replace 'dQw4w9WgXcQ' with the actual GTA VI trailer video ID
